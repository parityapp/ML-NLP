...
def cluster_keywords(keylist, outputfile):
    ...
    '''for keyword in keylist:
        print(i)
        for j in range(keylist.index(keyword)+1,n):
            print(keylist[j])
        i=i+1'''
    #for keyword in keylist:
    i=0
    while(i<len(keylist)):
        ...
        #for j in range(keylist.index(keyword)+1,len(keylist)):
        while(j<len(keylist)):
            next_word=keylist[j]
...
def get_unigram_dist(text):
   ...
   stopf = open("/home/cis505/hackathon/stopwords.txt","r")
...
def load_collection_tokens(directory):
    ...
    stopf = open("/home1/c/cis530/hw4/stopwords.txt","r")
    stop_words = stopf.readlines()
    stopf.close()
    stop_words = [word.strip() for word in stop_words]
...
if __name__ == "__main__":
    #ques 2
    #keylist=load_topic_words("/home1/a/agrima/hw4_agrima/dev_10.ts",20)
    
    #outputfile1 = "/home/agrima/cis530/hw4/hw4_3.txt"
    #ques3
    #cluster_keywords(keylist, "/home1/a/agrima/hw4_agrima/trial.txt")
